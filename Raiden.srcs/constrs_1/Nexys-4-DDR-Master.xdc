...
set_property -dict {PACKAGE_PIN H17 IOSTANDARD LVCMOS33} [get_ports led_glitch_out]
set_property -dict {PACKAGE_PIN K15 IOSTANDARD LVCMOS33} [get_ports led5_debug]
set_property -dict {PACKAGE_PIN J13 IOSTANDARD LVCMOS33} [get_ports led6_debug]
set_property -dict {PACKAGE_PIN N14 IOSTANDARD LVCMOS33} [get_ports led_blink]
...
set_property -dict {PACKAGE_PIN G14 IOSTANDARD LVCMOS33} [get_ports led2_b]
set_property -dict {PACKAGE_PIN R11 IOSTANDARD LVCMOS33} [get_ports led2_g]
set_property -dict {PACKAGE_PIN N16 IOSTANDARD LVCMOS33} [get_ports led2_r]
...
set_property -dict {PACKAGE_PIN C17 IOSTANDARD LVCMOS33} [get_ports trigger_in]
#set_property -dict {PACKAGE_PIN D18 IOSTANDARD LVCMOS33} [get_ports { JA[2] }]
set_property -dict {PACKAGE_PIN E18 IOSTANDARD LVCMOS33} [get_ports gpio_out]
set_property -dict {PACKAGE_PIN G17 IOSTANDARD LVCMOS33} [get_ports invert_glitch_out]
set_property -dict {PACKAGE_PIN D17 IOSTANDARD LVCMOS33} [get_ports armed_out]
set_property -dict {PACKAGE_PIN E17 IOSTANDARD LVCMOS33} [get_ports glitched_out]
set_property -dict {PACKAGE_PIN F18 IOSTANDARD LVCMOS33} [get_ports finished_out]
#set_property -dict {PACKAGE_PIN G18 IOSTANDARD LVCMOS33} [get_ports { JA[10] }]


##Pmod Header JB

set_property -dict { PACKAGE_PIN D14   IOSTANDARD LVCMOS33 } [get_ports { gpio_in1 }]; #IO_L1P_T0_AD0P_15 Sch=jb[1]
set_property -dict { PACKAGE_PIN F16   IOSTANDARD LVCMOS33 } [get_ports { gpio_in2 }]; #IO_L14N_T2_SRCC_15 Sch=jb[2]
set_property -dict { PACKAGE_PIN G16   IOSTANDARD LVCMOS33 } [get_ports { reset_out }]; #IO_L13N_T2_MRCC_15 Sch=jb[3]
set_property -dict { PACKAGE_PIN H14   IOSTANDARD LVCMOS33 } [get_ports { debug_io0_14_p30 }]; #IO_L15P_T2_DQS_15 Sch=jb[4]
set_property -dict { PACKAGE_PIN E16   IOSTANDARD LVCMOS33 } [get_ports { glitch_out }]; #IO_L11N_T1_SRCC_15 Sch=jb[7]
...
set_property -dict {PACKAGE_PIN C4 IOSTANDARD LVCMOS33} [get_ports ftdi_rx]
set_property -dict {PACKAGE_PIN D4 IOSTANDARD LVCMOS33} [get_ports ftdi_tx]
